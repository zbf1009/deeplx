...
describe("Translation Integration Tests", () => {
  ...
  describe("End-to-end translation flow", () => {
    ...
    it("should complete Microsoft Translator workflow", async () => {
      // Mock Microsoft Translator auth token response
      global.fetch = jest
        .fn()
      ...
      const { translateWithMicrosoft } = await import(
        "../../src/lib/services/microsoftTranslator"
      );
      ...
      // Verify both auth and translate API calls were made
